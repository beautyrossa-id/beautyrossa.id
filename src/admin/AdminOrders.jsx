  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] font-sans">
      <header className="border-b border-[#E8E1DB] bg-white px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        <div>
          <h1 className="text-lg font-semibold text-[#282422]">Daftar Pesanan</h1>
          <p className="text-xs text-[#6D6662]">Beauty Rossa Admin</p>
        </div>
        <button
        ...
        {!loading && !error && orders.length > 0 && (
          <div className="overflow-x-auto border border-[#E8E1DB] rounded-xl bg-white">
            <table className="w-full text-sm">
              <thead className="bg-[#F6F0EA] sticky top-[73px]">
